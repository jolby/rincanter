...
* About
  ...
  Rincanter is a [[http://clojure.org][Clojure]]/[[http://data-sorcery.org/][Incanter]] wrapper around the 
  ...
  [[http://clojure.org][Clojure]]/[[http://data-sorcery.org/][Incanter]] datatypes and R datatypes such as R dataframe to
  Incanter dataset.
